...
/**
 * Image components for the Projects section.
 */
...
// ---------------------------------------------------------------------------
// LEA4N - Context-Aware PDF Student AI
// ---------------------------------------------------------------------------
/**
 * Displays the image for the Lea4n context-aware AI platform.
 * 
 * @param {Object} props - Component properties
 * @param {string} [props.className] - Optional CSS classes for styling
 * @returns {JSX.Element} The image component
 */
export const Lea4nAnimation = ({ className }: { className?: string }) => (
    <img
        src="/lea4n.png"
